...
export function ActionButtons({ onMarkAsMastered, onMarkAsUnmastered, disabled, darkMode = false }: ActionButtonsProps) {
  return (
      ...
      <div className="flex gap-4">
        ...
        <button
          ...
          className={`
            ...
            active:scale-96
            ${darkMode ? 'shadow-dark-md hover:shadow-dark-lg' : 'shadow-md hover:shadow-lg'}
          `}
        >
          <X className="w-5 h-5" />
          未掌握
