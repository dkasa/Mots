...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ...
    className={cn(
      ...
      "bg-white text-gray-900 border-gray-200 dark:bg-neutral-dark-100 dark:text-neutral-dark-800 dark:border-neutral-dark-300",
      className
    )}
    {...props}
  />
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      "focus:bg-gray-100 focus:text-gray-900 dark:focus:bg-neutral-dark-300 dark:focus:text-neutral-dark-900",
      inset && "pl-8",
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator
    ref={ref}
    className={cn("-mx-1 my-1 h-px bg-gray-200 dark:bg-neutral-dark-300", className)}
    {...props}
  />
))
